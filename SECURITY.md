...
2. **Environment Variables**: Store sensitive configuration in `.env` files and load them in your application (e.g., via `dotenv`). The middleware reads its configuration from `process.env` at runtime
